package com.ericsson.android.widget
...
import com.ericsson.android.common.getEditText
import com.ericsson.android.data.protocol.GoodsSku
...
//            val height = mRootView.findViewById(R.id.mPopView).top
    ...
    fun getSelectSku(): String {
        ...
        for (skuView in mSkuViewList) {
            skuInfo += skuView.getSkuInfo().split(BaseConstant.SKU_SEPARATOR)[1] + BaseConstant.SKU_SEPARATOR
        }
