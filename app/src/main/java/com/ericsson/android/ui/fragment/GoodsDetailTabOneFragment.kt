...
import com.ericsson.android.event.GoodsDetailImageEvent
import com.ericsson.android.event.SkuChangedEvent
...
import com.ericsson.android.presenter.GoodsDetailPresenter
import com.ericsson.android.presenter.view.GoodsDetailView
import com.ericsson.android.ui.activity.GoodsDetailActivity
import com.ericsson.android.widget.GoodsSkuPopView
...
class GoodsDetailTabOneFragment : BaseMvpFragment<GoodsDetailPresenter>(), GoodsDetailView {
   ...
   */
    ...
    private fun loadData() {
        mPresenter.getGoodsDetailList(activity!!.intent.getIntExtra(BaseConstant.KEY_GOODS_ID, -1))
    }
    ...
    private fun initObserve(){
        Bus.observe<SkuChangedEvent>()
                .subscribe {
                    mSkuSelectedTv.text = mSkuPop.getSelectSku() +BaseConstant.SKU_SEPARATOR + mSkuPop.getSelectCount()+"件"
                }.registerInBus(this)
