...
import com.ericsson.android.event.CartAllCheckedEvent
import com.ericsson.android.event.UpdateCartSizeEvent
import com.ericsson.android.event.UpdateTotalPriceEvent
import com.ericsson.android.injection.component.DaggerCartComponent
import com.ericsson.android.injection.module.CartModule
import com.ericsson.android.presenter.CartListPresenter
import com.ericsson.android.presenter.view.CartListView
import com.ericsson.android.ui.adapter.CartGoodsAdapter
...
class CartFragment : BaseMvpFragment<CartListPresenter>(), CartListView {
    ...
    override fun onGetCartListResult(result: MutableList<CartGoods>?) {
        ...
        //本地存储并发送事件刷新UI
        AppPrefsUtils.putInt(BaseConstant.SP_CART_SIZE,result?.size?:0)
