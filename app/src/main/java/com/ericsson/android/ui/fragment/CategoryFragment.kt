...
import com.ericsson.android.injection.component.DaggerCategoryComponent
import com.ericsson.android.injection.module.CategoryModule
import com.ericsson.android.presenter.CategoryPresenter
import com.ericsson.android.presenter.view.CategoryView
import com.ericsson.android.ui.activity.GoodsActivity
import com.ericsson.android.ui.adapter.SecondCategoryAdapter
import com.ericsson.android.ui.adapter.TopCategoryAdapter
...
class CategoryFragment : BaseMvpFragment<CategoryPresenter>(), CategoryView {
    ...
    private fun initView() {
        ...
        secondAdapter.setOnItemClickListener(object : BaseRecyclerViewAdapter.OnItemClickListener<Category> {
            override fun onItemClick(item: Category, position: Int) {
                startActivity<GoodsActivity>(BaseConstant.KEY_CATEGORY_ID  to item.id)
            }
        })
